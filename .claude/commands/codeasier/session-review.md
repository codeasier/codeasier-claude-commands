...
- 总是先读取：`.claude/commands/codeasier/_refs/session-review/shared.sop`
- 当 `$1=troubleshoot` 时，再读取：`.claude/commands/codeasier/_refs/session-review/troubleshoot.sop`
- 当 `$1=summary` 时，再读取：`.claude/commands/codeasier/_refs/session-review/summary.sop`
